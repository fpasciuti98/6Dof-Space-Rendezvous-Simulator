...
MODEL                = Simulink_6DoF_RV
MODULES              = rt_logging_simtarget.c Simulink_6DoF_RV.c Simulink_6DoF_RV_capi.c Simulink_6DoF_RV_data.c Simulink_6DoF_RV_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c rt_zcfcn.c rt_logging_mmi_simtarget.c rtw_modelmap_utils_simtarget.c raccel_main.c raccel_sup.c raccel_mat.c simulink_solver_api.c raccel_utils.c common_utils.c ext_svr.c updown.c ext_work.c rtiostream_interface.c rtiostream_tcpip.c rtiostream_utils.c
PRODUCT              = Simulink_6DoF_RV.exe
MAKEFILE             = Simulink_6DoF_RV.mk
MATLAB_ROOT          = D:/Programmi/MATLAB
ALT_MATLAB_ROOT      = D:/Programmi/MATLAB
START_DIR            = C:/Users/Asus/Desktop/UNIVER~1/ZZSUPE~1.ZZ/DINAMI~1/SIMULA~2/GRUPPO6/FILEPR~1/CUBESA~1
S_FUNCTIONS_LIB      = $(MATLAB_ROOT)\sys\lcc64\lcc64\lib64\wsock32.lib
NUMST                = 5
NCSTATES             = 38
BUILDARGS            =  RSIM_SOLVER_SELECTION=2 PCMATLABROOT="D:\\Programmi\\MATLAB" EXTMODE_STATIC_ALLOC=0 EXTMODE_STATIC_ALLOC_SIZE=1000000 EXTMODE_TRANSPORT=0 TMW_EXTMODE_TESTING=0 RSIM_PARAMETER_LOADING=1 OPTS="-DTGTCONN -DIS_SIM_TARGET -DNRT -DRSIM_PARAMETER_LOADING -DRSIM_WITH_SL_SOLVER -DENABLE_SLEXEC_SSBRIDGE=1 -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0 -DON_TARGET_WAIT_FOR_START=0 -DTID01EQ=1"
MULTITASKING         = 0
INTEGER_CODE         = 0
MAT_FILE             = 1
ALLOCATIONFCN        = 0
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/raccel/Simulink_6DoF_RV \
